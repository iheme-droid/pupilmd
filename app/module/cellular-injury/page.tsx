...
export default function CellularInjuryModule() {
  return (
    <div style={{ padding: '40px', color: '#fff', backgroundColor: '#0D0F14', minHeight: '100vh', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <h1 style={{ fontFamily: "'Sora', sans-serif", fontSize: '2.5rem', marginTop: '20px' }}>Cellular Injury & Death</h1>
      <p style={{ color: 'rgba(255,255,255,0.7)', maxWidth: '600px' }}>
        Learn about reversible vs. irreversible cell injury, necrosis, and apoptosis mechanisms.
      </p>
    </div>
  );
}