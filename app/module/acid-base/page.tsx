...
export default function AcidBaseModule() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      {/* Module Header */}
      <div className="mb-8">
        <Link href="/" className="text-green-600 hover:text-green-700 mb-4 inline-block font-semibold">
          ← Back to Home
        </Link>
        ...
        <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-r-lg mb-8">
          ...
          <ul className="space-y-2 text-green-800">
            <li className="flex items-start">
              ...
              <span>The three-system approach to pH regulation (buffers, lungs, kidneys)</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-600 mr-2">✓</span>
              <span>How to systematically interpret arterial blood gases (ABGs)</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-600 mr-2">✓</span>
              <span>How to identify and manage the four primary acid-base disorders</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-600 mr-2">✓</span>
              <span>Why electrolyte disorders and acid-base problems go hand-in-hand</span>
            </li>
          </ul>
        </div>
      ...
      <div className="space-y-3 mb-8">
        ...
        {/* Core Sections (0-9) */}
        {acidBaseChapter.sections.slice(0, 10).map((section) => (
          <div
            key={section.id}
            className="bg-white border border-gray-200 rounded-lg p-5 hover:border-green-300 hover:shadow-md transition-all duration-200"
          >
            ...
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-semibold text-gray-900 text-lg">
                    {acidBaseChapter.sections[10].title}
                  </h3>
                ...
                <p className="text-purple-800 text-sm ml-11">
                  Deep dive into advanced concepts and formulas. Complete sections 0-9 first for full understanding.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="text-center">
        <Link
          ...
          className="inline-block bg-gradient-to-r from-green-600 to-emerald-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200"
        >
          Start Learning →
        </Link>
      </div>
